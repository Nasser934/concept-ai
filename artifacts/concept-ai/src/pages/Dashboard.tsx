    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="container mx-auto px-6 py-10">
        <div className="mb-8 flex items-center justify-between">
          ...
          <Button onClick={() => setLocation("/analyze")} className="gap-2"><Plus className="h-4 w-4" /> New analysis</Button>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-dashed border-border bg-card/30 py-20 text-center">
            ...
            <Button onClick={() => setLocation("/analyze")} className="mt-4 gap-2"><Plus className="h-4 w-4" /> Run your first</Button>
          </div>
        ) : (
