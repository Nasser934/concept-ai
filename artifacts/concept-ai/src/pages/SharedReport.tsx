        ...
        <div className="container mx-auto flex h-14 items-center justify-between px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => {
              sessionStorage.setItem("__concept_ai_result__", JSON.stringify({ report: row.output, inputs: row.inputs, slug: row.slug }));
              setLocation("/results");
            }}
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">{row.industry} · saved {new Date(row.createdAt).toLocaleDateString()}</p>
          </div>
